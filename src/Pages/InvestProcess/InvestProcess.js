    ...
    return (
        <React.Fragment>
            ...
            <div className='container'>
                <div className="col-lg-6 col-xl-12 col-xxl-6 h-100">

                    <div className="card theme-wizard h-100 mb-5">
                        <div className="card-header  pt-3 pb-2" style={{backgroundColor: 'white'}}>
                        ...
                        <div className="card-body py-4" id="wizard-controller">
                            <div className="tab-content">
                                    ...
                                    <form className="needs-validation" noValidate="novalidate">
                                        <div className="mb-3">
                                            <label
                                                ...
                                                htmlFor="bootstrap-wizard-validation-wizard-name"
                                            >
                                                Name
                                            </label>
                                            <input
                                        ...
                                        <div className="mb-3">
                                            <label
                                                className="form-label"
                                                htmlFor="bootstrap-wizard-validation-wizard-email"
                                            >
                                                Email*
                                            </label>
                                            <input
                                            ...
                                            />
                                            <div className="invalid-feedback">You must add email</div>
                                        </div>
                                        <div className="row g-2">
                                            <div className="col-6">
                                                <div className="mb-3">
                                                    <label
                                                        className="form-label"
                                                        htmlFor="bootstrap-wizard-validation-wizard-password"
                                                    >
                                                        Password*
                                                    </label>
                                                    <input
                                            ...
                                            <div className="col-6">
                                                <div className="mb-3">
                                                    <label
                                                        className="form-label"
                                                        htmlFor="bootstrap-wizard-validation-wizard-confirm-password"
                                                    >
                                                        Confirm Password*
                                                    </label>
                                                    <input
                                                    ...
                                                    />
                                                    <div className="invalid-feedback">Passwords need to match</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="form-check">
                                            <input
                                                ...
                                                id="bootstrap-wizard-validation-wizard-checkbox"
                                            />
                                            <label
                                                className="form-check-label"
                                                htmlFor="bootstrap-wizard-validation-wizard-checkbox"
                                            >
                                ...
                                <div
                                    className="tab-pane px-sm-3 px-md-5"
                                    role="tabpanel"
                                ...
                                >
                                    <form>
                                        <div className="mb-3">
                                            <div
                                                className="row dz-clickable"
                                                data-dropzone="data-dropzone"
                                                data-options='{"maxFiles":1,"data":[{"name":"avatar.png","size":"54kb","url":"../../assets/img/team"}]}'
                                            >
                                                <div className="col-md-auto">
                                                    <div className="dz-preview dz-preview-single">
                                                        <div className="dz-preview-cover d-flex align-items-center justify-content-center mb-3 mb-md-0 dz-image-preview">
                                                            {" "}
                                                ...
                                                <div className="col-md">
                                                    ...
                                                    >
                                                        <div className="text-center">
                                                            ...
                                                            <p className="mb-0 fs--1 text-400">
                                        ...
                                        <div className="mb-3">
                                            <label
                                                className="form-label"
                                                htmlFor="bootstrap-wizard-validation-wizard-phone"
                                            >
                                                Phone
                                            </label>
                                            <input
                                        ...
                                        <div className="mb-3">
                                            <label
                                                className="form-label"
                                                htmlFor="bootstrap-wizard-validation-wizard-datepicker"
                                            >
                                                Date of Birth
                                            </label>
                                            <input
                                        ...
                                        <div className="mb-3">
                                            <label
                                                className="form-label"
                                                htmlFor="bootstrap-wizard-validation-wizard-address"
                                            >
                                                Address
                                            </label>
                                            <textarea
                                                className="form-control"
                                                rows={4}
                                                id="bootstrap-wizard-validation-wizard-address"
                                                defaultValue={""}
                                            />
                                        </div>
                                    </form>
                                                ...
                                                <div className="col-md">
                                                    ...
                                                    >
                                                        <div className="text-center">
                                                            ...
                                                            Upload your profile picture
                                                            <p className="mb-0 fs--1 text-400">
                                                                Upload a 300x300 jpg image with <br />a maximum size of
                                                                400KB
                                                            </p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="row g-2">
                                            <div className="col">
                                                <div className="mb-3">
                                                    <label
                                                        className="form-label"
                                                        htmlFor="bootstrap-wizard-validation-card-number"
                                                    >
                                                        Card Number
                                                    </label>
                                                    <input
                                            ...
                                            <div className="col">
                                                <div className="mb-3">
                                                    <label
                                                        className="form-label"
                                                        htmlFor="bootstrap-wizard-validation-card-name"
                                                    >
                                                        Name on Card
                                                    </label>
                                                    <input
                                        ...
                                        <div className="row g-2">
                                            <div className="col-6">
                                                <div className="mb-3">
                                                    <label
                                                        className="form-label"
                                                        htmlFor="bootstrap-wizard-validation-card-holder-zip-code"
                                                    >
                                                        Zip Code
                                                    </label>
                                                    <input
                                            ...
                                            <div className="col-6">
                                                <div className="form-group mb-0">
                                                    <label
                                                        className="form-label"
                                                        htmlFor="bootstrap-wizard-validation-card-exp-date"
                                                    >
                                                        Exp Date
                                                    </label>
                                                    <input
                                            ...
                                            <div className="col-6">
                                                <div className="form-group mb-0">
                                                    <label
                                                        className="form-label"
                                                        htmlFor="bootstrap-wizard-validation-card-cvv"
                                                    >
                                                        CVV
                                                    </label>
                                                    <span
                                                    ...
                                                    >
                                                        ...
                                                        {/* <span class="fa fa-question-circle"></span> Font Awesome fontawesome.com */}
                                                    </span>
                                                    <input
                                                        className="form-control"
                                                        placeholder={123}
                                                        ...
                                                        pattern="[0-9]{3}"
                                                        type="text"
                                                        id="bootstrap-wizard-validation-card-cvv"
                                                    />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div
                                    className="tab-pane text-center px-sm-3 px-md-5"
                                    role="tabpanel"
                                ...
                                >
                                    <div className="wizard-lottie-wrapper">
                                        <div
                                            className="lottie wizard-lottie mx-auto my-3"
                                            ...
                                            >
                                                <defs>
                                                    <clipPath id="__lottie_element_10">
                                                        <rect width={264} height={464} x={0} y={0} />
                                                    </clipPath>
                                                </defs>
                                                <g clipPath="url(#__lottie_element_10)">
                                                    ...
                                                    >
                                                        <g
                                                            opacity={1}
                                                            transform="matrix(1,0,0,1,0,146.08152770996094)"
                                                        >
                                                            <g
                                                                opacity={1}
                                                                transform="matrix(0.999881386756897,0.015403416007757187,-0.015403416007757187,0.999881386756897,1.492624282836914,0.4111328125)"
                                                            >
                                                                ...
                                                                <g
                                                                    opacity={1}
                                                                    transform="matrix(1,0,0,0.7300001382827759,0,16.554397583007812)"
                                                                >
                                                                    <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                        <path
                                                                            fill="rgb(36,193,224)"
                                                            ...
                                                            <g
                                                                opacity={1}
                                                                transform="matrix(0.9975984692573547,-0.06926261633634567,0.06926261633634567,0.9975984692573547,-6.988677978515625,2.4860076904296875)"
                                                            >
                                                                <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                    <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                        <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                        ...
                                                                        <g
                                                                            opacity={1}
                                                                            transform="matrix(0.8810532093048096,-0.473017156124115,0.473017156124115,0.8810532093048096,-36.38174057006836,17.062271118164062)"
                                                                        >
                                                                            <path
                                                                                fill="rgb(209,226,253)"
                                                                                fillOpacity={1}
                                                                        ...
                                                                        <g
                                                                            opacity={1}
                                                                            transform="matrix(0.8734241724014282,0.48696020245552063,-0.48696020245552063,0.8734241724014282,45.38072967529297,-13.913894653320312)"
                                                                        >
                                                                            <path
                                                                                fill="rgb(209,226,253)"
                                                                                fillOpacity={1}
                                                                ...
                                                                <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                    <g
                                                                        opacity={1}
                                                                        transform="matrix(1,0,0,0.9999985694885254,0,0.0001068115234375)"
                                                                    >
                                                                        <path
                                                                            fill="rgb(66,133,244)"
                                                                            fillOpacity={1}
                                                            ...
                                                            <g
                                                                opacity={1}
                                                                transform="matrix(0.992416501045227,-0.12292053550481796,0.12292053550481796,0.992416501045227,-12.588386535644531,-8.868888854980469)"
                                                            >
                                                                <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                    <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                        <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                ...
                                                                <g
                                                                    opacity={1}
                                                                    transform="matrix(1,0,0,0.7500011324882507,0,15.995674133300781)"
                                                                >
                                                                    <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                        <path
                                                                            fill="rgb(66,133,244)"
                                                            ...
                                                            <g
                                                                opacity={1}
                                                                transform="matrix(0.9933338165283203,0.1152733638882637,-0.1152733638882637,0.9933338165283203,11.786819458007812,-9.542388916015625)"
                                                            >
                                                                <g
                                                                    opacity={1}
                                                                    transform="matrix(1,0,0,1,0.0000457763671875,-0.0000457763671875)"
                                                                >
                                                                    <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                        <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                            <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                        ...
                                                                        <g
                                                                            opacity={1}
                                                                            transform="matrix(0.6011377573013306,-0.7991454005241394,0.7991454005241394,0.6011377573013306,-35.654380798339844,85.31422424316406)"
                                                                        >
                                                                            <path
                                                                                fill="rgb(203,240,248)"
                                                                                fillOpacity={1}
                                                                        ...
                                                                        <g
                                                                            opacity={1}
                                                                            transform="matrix(0.8000590205192566,0.5999213457107544,-0.5999213457107544,0.8000590205192566,63.39178466796875,-45.95453643798828)"
                                                                        >
                                                                            <path
                                                                                fill="rgb(203,240,248)"
                                                                                fillOpacity={1}
                                                                ...
                                                                <g
                                                                    opacity={1}
                                                                    transform="matrix(1,0,0,1,0.000030517578125,-0.00003814697265625)"
                                                                >
                                                                    <g
                                                                        opacity={1}
                                                                        transform="matrix(1,0.0000014965021364332642,-0.0000014964984984544571,0.9999975562095642,0.00011444091796875,0.0000457763671875)"
                                                                    >
                                                                        <path
                                                                            fill="rgb(36,193,224)"
                                                                            fillOpacity={1}
                                                        ...
                                                        <g
                                                            opacity={1}
                                                            transform="matrix(0.9816271662712097,0.1908089965581894,-0.1908089965581894,0.9816271662712097,2.9829235076904297,163.62364196777344)"
                                                        >
                                                            <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                    <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                ...
                                                                <g
                                                                    opacity={1}
                                                                    transform="matrix(0.6793879270553589,-0.7337793111801147,0.7337793111801147,0.6793879270553589,-4.63386344909668,-11.09203052520752)"
                                                                >
                                                                    <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                        <path
                                                                            fill="rgb(209,226,253)"
                                                                ...
                                                                <g
                                                                    opacity={1}
                                                                    transform="matrix(0.8374733328819275,0.5464781522750854,-0.5464781522750854,0.8374733328819275,16.263439178466797,-8.732048034667969)"
                                                                >
                                                                    <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                        <path
                                                                            fill="rgb(209,226,253)"
                                                            ...
                                                            <g
                                                                opacity={1}
                                                                transform="matrix(1,-0.0000021009566353313858,0.0000021009566353313858,1,-0.0000057220458984375,-0.0000011920928955078125)"
                                                            >
                                                                <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                    <path
                                                                        fill="rgb(66,133,244)"
                                                            ...
                                                            <g
                                                                opacity={1}
                                                                transform="matrix(1,-0.0000015006833109509898,0.0000015006833109509898,1,0.000003337860107421875,0.00000667572021484375)"
                                                            >
                                                                <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                    <path
                                                                        fill="rgb(255,167,38)"
                                                            ...
                                                            <g
                                                                opacity={1}
                                                                transform="matrix(0.0664377212524414,0.9977905750274658,-0.9977905750274658,0.0664377212524414,61.919673919677734,-53.99172592163086)"
                                                            >
                                                                <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                    <g opacity={1} transform="matrix(1,0,0,1,0,0)">
                                                                        <path
                                                        ...
                                                        <g opacity={1} transform="matrix(1,0,0,1,0,147)">
                                                            ...
                                                            <g
                                                                opacity={0}
                                                                transform="matrix(1,0,0,1,0.000003814697265625,0)"
                                                            >
                                                                <path
                                                                    fill="rgb(246,102,56)"
                                                                    fillOpacity={1}
                                                            ...
                                                            <g
                                                                opacity={0}
                                                                transform="matrix(0.9063088893890381,-0.4226187765598297,0.4226187765598297,0.9063088893890381,-1.9754095077514648,0.05750417709350586)"
                                                            >
                                                                <path
                                                                    fill="rgb(52,168,83)"
                                                                    fillOpacity={1}
                            ...
                            <div className="px-sm-3 px-md-5">
                                <ul className="pager wizard list-inline mb-0">
                                    <li className="previous">
                                        <button className="btn btn-link ps-0 d-none" type="button">
                                            <svg
                                                className="svg-inline--fa fa-chevron-left fa-w-10 me-2"
                                            ...
                                            {/* <span class="fas fa-chevron-left me-2" data-fa-transform="shrink-3"></span> Font Awesome fontawesome.com */}
                                            Prev
                                        </button>
                                    </li>
                                    <li className="next">
                                        <button className="btn btn-primary px-5 px-sm-6" type="submit">
                                            Next
                                            <svg
                                                className="svg-inline--fa fa-chevron-right fa-w-10 ms-2"
                                                data-fa-transform="shrink-3"
                                                aria-hidden="true"
                                                focusable="false"
                                                data-prefix="fas"
                                            ...
                                            {/* <span class="fas fa-chevron-right ms-2" data-fa-transform="shrink-3"> </span> Font Awesome fontawesome.com */}
                                        </button>
                                    </li>
                                </ul>
                            </div>
